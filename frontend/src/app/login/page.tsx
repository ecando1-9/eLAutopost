                    ...
                    <div className="mt-8">
                        ...
                        <form className="mt-8 space-y-5" onSubmit={handleLogin}>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="flex w-full h-11 items-center justify-center rounded-xl bg-blue-600 text-sm font-semibold text-white shadow-md shadow-blue-600/20 hover:bg-blue-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 transition-all"
                            >
                                {loading ? (
                                    <>
            ...
            <div className="hidden lg:flex relative w-0 flex-1 border-l border-slate-200 z-10 bg-white items-center justify-center p-12">
                <div className="max-w-xl mx-auto text-center space-y-10">
                    <div className="inline-flex items-center space-x-2 bg-blue-50 border border-blue-100 rounded-full px-4 py-2 shadow-sm text-blue-700 font-semibold mb-2">
                        ...
                        <span className="text-sm">Trusted Enterprise Security</span>
                    </div>
